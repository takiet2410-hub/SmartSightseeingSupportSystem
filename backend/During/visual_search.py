...
import io
from core.config import MONGO_URI, DB_NAME, COLLECTION_NAME # Tận dụng file config cũ
...
try:
    ...
    info_collection = db["Destinations"]       # Collection chứa thông tin địa điểm (Module Before)
...
if __name__ == "__main__":
    print ("uvicorn visual_search:app --reload")