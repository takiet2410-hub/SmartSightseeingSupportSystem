...
Pipeline này xử lý **ý định, sở thích** của người dùng – ví dụ:

> “tôi muốn đi nơi yên bình, nhiều cây xanh, khí hậu mát mẻ, tắm biển”

Mục tiêu là **tìm các địa điểm du lịch có cảm xúc và hoạt động tương đồng nhất** trong cơ sở dữ liệu (CSDL) thông qua mô hình **SentenceTransformer + TF-IDF + Cosine Similarity + KNN**.
